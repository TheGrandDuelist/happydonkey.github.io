...
func (c *FansController) GetFansDE() *web.JsonResult {
	userId := params.FormValueInt64Default(c.Ctx, "userId", 0)
...
func (c *FansController) GetRecentFollowDE() *web.JsonResult {
	userId := params.FormValueInt64Default(c.Ctx, "userId", 0)
	userIds, cursor, hasMore := services.UserFollowService.GetFollows(userId, 0, 10)
...
func (c *FansController) GetFansNamesDE() *web.JsonResult {
	userId := params.FormValueInt64Default(c.Ctx, "userId", 0)
